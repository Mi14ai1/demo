...
var _introSlider = require("./modules/sliders/intro-slider.js");
var _initMoveTo = require("./modules/init-move-to.js");
var _scrollSlider = require("./modules/scroll-slider.js");
var _tabs = require("./modules/tabs.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    (0, _introSlider.initIntroSlider)();
    (0, _scrollSlider.initMainScrollSlider)();
    (0, _tabs.initTabs)();
...
},{"./modules/accordion/init-accordion.js":2,"./modules/init-move-to.js":3,"./modules/menu.js":4,"./modules/modals/init-modals":5,"./modules/scroll-slider.js":7,"./modules/sliders/intro-slider.js":8,"./modules/tabs.js":9,"./utils/ios-vh-fix":12}],2:[function(require,module,exports){
"use strict";
...
var checkButtonHeight = function checkButtonHeight() {
  if (!accordions) {
    return;
  }
  accordions.forEach(function (accordion) {
    ...
    accordionButtons.forEach(function (btn) {
      ...
      var contentHeight = parent.querySelector('.accordion__content').clientHeight;
      parent.style.setProperty('--btnHeight', "".concat(btnHeight + 4, "px"));
      parent.style.setProperty('--contentHeight', "".concat(contentHeight, "px"));
    });
  });
};
var initAccordion = function initAccordion() {
  ...
  accordions.forEach(function (accordion) {
    accordion.addEventListener('click', function (e) {
      var button = e.target.closest('.accordion__button');
      if (!button) {
        return;
      }
      checkButtonHeight();
...
var scrollToHandler = function scrollToHandler(evt) {
  var button = evt.target.closest('[data-move-to]');
  if (!button) {
    return;
  }
  evt.preventDefault();
  var target = document.querySelector(button.dataset.moveTo);
  var buttonTop = button.getBoundingClientRect().top;
  var targetTop = target.getBoundingClientRect().top;
  var duration = Math.abs(buttonTop - targetTop) / (window.innerHeight * 1.5);
  var options = {
    duration: duration,
    offset: 0
  };
...
var initScrollTo = function initScrollTo() {
  _gsapMin.gsap.registerPlugin(_ScrollToPluginMin.ScrollToPlugin);
...
},{"../utils/page-scroller.js":14,"../vendor/gsap/ScrollToPlugin.min.js":16,"../vendor/gsap/gsap.min.js":18}],4:[function(require,module,exports){
"use strict";
...
var menuBtn = document.querySelector('.js-burger');
var menu = document.querySelector('.main-nav');
var menuLIst = document.querySelector('.main-nav__list');
var subMenu = menu ? menu.querySelectorAll('.sub-menu') : '';
console.log(subMenu);
var scrollWidth = window.innerWidth - document.querySelector('body').clientWidth;
var desktopBreak = window.matchMedia("(max-width: ".concat(1024 + scrollWidth, "px)"));
var isSubDesktop = function isSubDesktop() {
  return window.innerWidth + scrollWidth < 1024;
};
var addingMenu = function addingMenu() {
  if (isSubDesktop()) {
...
var initMenu = function initMenu() {
  ...
  desktopBreak.addEventListener('change', function () {
...
},{"./modals":6}],6:[function(require,module,exports){
"use strict";
...
},{"../../utils/focus-lock":10,"../../utils/scroll-lock":15}],7:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initMainScrollSlider = exports.ScrollSlider = void 0;
...
var initMainScrollSlider = function initMainScrollSlider() {
  if (!sliderContainer) {
    return;
  }
  var scrollSlider = new ScrollSlider(sliderContainer);
};
exports.initMainScrollSlider = initMainScrollSlider;

},{"../utils/observers.js":13,"../vendor/gsap/ScrollTrigger.min.js":17}],8:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initIntroSlider = void 0;
var _swiper = _interopRequireDefault(require("../../vendor/swiper.js"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var slider = document.querySelector('.intro-slider');
var initIntroSlider = function initIntroSlider() {
  if (!slider) {
    return;
  }
  var introSlider = new _swiper.default('.intro-slider', {
    loop: false,
    spaceBetween: 10,
    autoHeight: false,
    navigation: {
...
exports.initIntroSlider = initIntroSlider;

},{"../../vendor/swiper.js":19}],9:[function(require,module,exports){
"use strict";
...
var tabsControls = document.querySelector('.js-tabs-buttons');
...
var initTabs = function initTabs() {
  ...
  tabsControls.addEventListener('click', function (e) {
    ...
    if (button) {
      var currentActiveBtn = tabsControls.querySelector('.is-active');
      var currentActiveTab = tabs.querySelector('.tab:not(.visually-hidden)');
      if (currentActiveTab) {
      ...
      var currentTab = tabs.querySelector(".tab[data-tab-name=".concat(button.dataset.tabName, "]"));
...
exports.resizeObserver = exports.EventObserver = void 0;
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }
function _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
...
},{"./ios-checker":11}],16:[function(require,module,exports){
"use strict";
